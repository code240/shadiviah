...
<div class="container-fluid maindiv_for_help">
    ...
    <div class="container-fluid middle_div">
        ...
        <center>
        <a style="text-decoration: none;" href="db/Feedbacks_db.php">
        <button class="btn btn-primary text-truncate action_btns">
            Contact us db
        </button>
        </a>
        <a style="text-decoration: none;" href="db/mediator_db.php">
          <button class="btn btn-primary text-truncate action_btns">
             Mediator details
          </button>
          </a>
        <a style="text-decoration:none;" href="db/Wedding_db.php" >
        <button class="btn btn-primary text-truncate action_btns">
            Weddings
         </button>
         </a>
         <a style="text-decoration:none;" href="db/Weddingimage_db.php">
         <button class="btn btn-primary text-truncate action_btns">
            Wedding images db
         </button>
         </a>
         <a style="text-decoration:none;" href="db/insight_db.php">
         <button class="btn btn-primary text-truncate action_btns">
            Insight db
         </button>
         </a>
         ...
         <button class="btn btn-warning text-truncate action_btns" onclick="window.open('# ','name','width=1600,height=1400')">
