<?php
error_reporting(0);
 include 'source-php/after-wedding-select.php';
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <title>Invite Someone Through Shadiviah</title>
...
<div class="container-fluid image_shower">
  <h6 class="about_us_heading6"><?php echo $_SESSION['firstname']; ?> <span style="color:#fc237e;"> weds </span> <?php echo $_SESSION['secondname']; ?></h6>
...
<div class="container-fluid background_of_form_div">
    <span class="ask_for_url">Please enter the name of your friend / Relative whom you want to invite.</span>
    <form action="Invite-Messages" method="POST" name="form" onsubmit="return validform();" >
      <center>
      
            <input type="text" name="invite_name" autocomplete="off" id="inviteholdername" class="input_code" placeholder="Name"><br>
            <div class="form-check checkbox_div">
                
                <input class="form-check-input checkbox" type="checkbox" active checked id="gridCheck" name="familystatus">
                <label class="form-check-label checkbox_label" for="gridCheck">
                  With family
                </label>
              </div>
          
            <input type="submit" value="Create" class="btn btn-primary btn_create">
...
<script>
function validform(){
   var wed = document.forms['form']['invite_name'].value;
   if(wed.trim()==""){
     alert('Please enter the name of person whom you want to invite');
     return false;
   }
   return true;
}
