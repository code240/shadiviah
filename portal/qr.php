...
<header class="container-fluid top">
   <a href="" class="atag-head" style="text-decoration: none;">
    Shadiviah.in
   </a> 
</header>
<center>
...
<h2 class="url-tag" ><?php echo $url; ?><br><br>And wedding one time password is: <?php echo $wed_code; ?></h2>

<button class="btn btn-warning back_btn" onclick="window.location.assign('Mediator-access');">Back</button>
