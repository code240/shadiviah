...
if(isset($_COOKIE['SHADIVIAH_MEDIATOR'])){
    if($_FILES['i1']['name']!=""){
        ...
        $queryfire = "insert into wedding_images (image,caption,feature,weddingcode,register_date,register_time,deletestatus) values ('$name','$caption',0,'$weddingcode','$register_date','$register_time',0)";
    ...
    if($_FILES['i2']['name']!=""){
        ...
        $queryfire = "insert into wedding_images (image,caption,feature,weddingcode,register_date,register_time) values ('$name','$caption',0,'$weddingcode','$register_date','$register_time')";
        mysqli_query($con,$queryfire);
    }
    if($_FILES['i3']['name']!=""){
        $name = $_FILES['i3']['name'];
