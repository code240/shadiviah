...
if($rowcount==1){
    ...
    if($rowcount==15){
        echo "<script>alert('Maximum limit reached for Featured image (15)');window.location.assign('../../Portal/Mediator-Access');</script>";
   }   
   if($rowcount>15){
       echo "<script>alert('Max value already crossed (15)');window.location.assign('../../Portal/Mediator-Access');</script>";
   } 
