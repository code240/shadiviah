...
<center>
    <h1>
        FAMILY MEMBERS IMAGE AND THEIR NAME.
    </h1>    
</center>
<div  class="container-fluid form_div">
  <form action="php/pagethreeimage.php" onsubmit="return validform();" name="form" method="POST" enctype="multipart/form-data">

     <label class="label_two"> Image One</label>
     <input type="file" accept="image/*"  name="i1"  class="imageupload"><br>
     <input type="text" name="c1" autocomplete="off" class="imagecaption" id="" placeholder="Image caption 1">
     
     <label class="label_two"> Image Two</label>
     <input type="file" accept="image/*"  name="i2"  class="imageupload"><br>
     <input type="text" name="c2" autocomplete="off" class="imagecaption" id="" placeholder="Image caption 2">
     
     <label class="label_two"> Image Three</label>
     <input type="file"  accept="image/*" name="i3"  class="imageupload"><br>
     <input type="text" name="c3" autocomplete="off" class="imagecaption" id="" placeholder="Image caption 3">
     
     <label class="label_two"> Image Four</label>
     <input type="file" accept="image/*"  name="i4"  class="imageupload"><br>
     <input type="text" name="c4" autocomplete="off" class="imagecaption" id="" placeholder="Image caption 4">
  ...
  <!-- <button class="btn btn-success latter_btn">Latter</button> -->
  ...
  function validform(){
    ...
    if(i1!=""){
        if(c1==""){
          ...
          alert("PLEASE ENTER THE CAPTION OF IMAGE");
          return false;
        }
    }
    if(i2!=""){
